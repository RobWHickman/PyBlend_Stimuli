...
Directory = path.expanduser("~/Desktop")

Output_directory = (str(Directory) + "/Summerfield-Lab-master/tree_blend/imagebin")
	...
	if Grid_size > 1:
		for x_repeat in range(Grid_size):
			for y_repeat in range(Grid_size):
				...
				environment_add(Texture_folder = (str(Directory) + "/Summerfield-Lab-master/tree_blend/Tree Textures"))
				#render it all
